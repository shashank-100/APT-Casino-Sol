...
export type CloseInput<
  ...
  TAccountRoulette extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountRoulette>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountRoulette> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.roulette),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountRoulette>;
